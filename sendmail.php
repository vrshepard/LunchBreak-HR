...
<head>
    ...
    <meta name="keywords" content="WEBDEV114, HTML Contact Form">
...
<body>
		...
		<fieldset>
			...
			<label for="type_of_inquiry">Subject:</label>
			<input type="text" name="type_of_inquiry" id="type_of_inquiry" value="<?php echo $_REQUEST['type_of_inquiry'] ?>" disabled><br>
...
<?php
  ...
  //Set admin email for email to be sent to (use you own MATC email address)
    $admin_email = "sheparv1@gmatc.matc.edu"; 
  ...
  //Set PHP variable equal to information completed on the HTML form
    ...
    $subject = "LBHR Contact Request - " . $_REQUEST['type_of_inquiry']; //Request subject that user typed on HTML form
  ...
  echo "Thanks for sending us a message. We will get back to you as soon as we can."; 
  }
  
  //if "email" variable is not filled out, display an error
  else  { 
     echo "OOPS! Something went wrong! #sadface";
        }
?>
